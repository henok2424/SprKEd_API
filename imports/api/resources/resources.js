...
const validTypes = ['png', 'jpg', 'jpeg', 'mp4', 'pdf', 'gif', 'mp3', 'pptx', 'ppt', 'xls','xlsx','webm', 'ogg', 'txt', 'doc','docx','mov','exe','apk','webm','MPG', 'MP2', 'MPEG', 'MPE', 'MPV','M4P', 'M4V','avi','wma','wmv','flv','swf','html','css'];
